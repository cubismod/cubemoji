...
import { EditOperation, generateEditOptions, RescaleOperation } from "../../lib/image/ImageLogic"
...
const urls = [
  ...
  'https://commons.wikimedia.org/wiki/File:Frontal_lobe_animation.gif',
  'https://commons.wikimedia.org/wiki/File:2004_Indonesia_Tsunami_Complete.gif',
  ...
  'https://commons.wikimedia.org/wiki/File:North_Middlesex_CC_v_Tetherdown_Trundlers_CC_at_Crouch_End,_Haringey,_London_110.gif',
  'https://upload.wikimedia.org/wikipedia/commons/3/38/Crew_after_sinking_of_SMS_Seeadler.gif',
  'https://commons.wikimedia.org/wiki/File:Newtons_cradle_animation_book.gif',
  'https://upload.wikimedia.org/wikipedia/commons/6/62/Cicada_molting_animated-2.gif'
]

export const rescaleSuite = suite('Rescale')
export const editSuite = suite('Edit')
export const addFaceSuite = suite('AddFace')
